...
positive = data[data["Bought_Status"]=="Bought"]
negative = data[data["Bought_Status"]!="Bought"]

# COMMAND ----------

selected_crit = int(0.8 * len(positive) // 1)
...
broadcast_data = sc.broadcast( (X_train, y_train, X_val, y_val) )
